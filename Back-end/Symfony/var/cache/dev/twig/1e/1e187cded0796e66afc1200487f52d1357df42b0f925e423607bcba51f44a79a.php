...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@Debug/Profiler/dump.html.twig", "/home/nicolas/apothéose/projet-adopte-une-serie/Back-end/Symfony/vendor/symfony/debug-bundle/Resources/views/Profiler/dump.html.twig");
    }
}
