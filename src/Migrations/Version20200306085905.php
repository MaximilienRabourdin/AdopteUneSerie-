 ...
 */
final class Version20200306085905 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cast CHANGE `character` `character` VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `cast` CHANGE `character` `character` INT NOT NULL');
    }
}
