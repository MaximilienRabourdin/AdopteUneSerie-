 ...
 */
final class Version20200306133447 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE network_serie DROP FOREIGN KEY FK_64202A68D94388BD');
        $this->addSql('ALTER TABLE user_serie DROP FOREIGN KEY FK_48F8686CD94388BD');
        $this->addSql('ALTER TABLE production_compagny_serie DROP FOREIGN KEY FK_CCD043CED94388BD');
        $this->addSql('ALTER TABLE original_country_serie DROP FOREIGN KEY FK_C2BB5F81D94388BD');
        ...
        $this->addSql('ALTER TABLE network_serie DROP FOREIGN KEY FK_64202A6834128B91');
        $this->addSql('ALTER TABLE rating DROP FOREIGN KEY FK_D8892622A76ED395');
        $this->addSql('ALTER TABLE user_serie DROP FOREIGN KEY FK_48F8686CA76ED395');
        $this->addSql('ALTER TABLE production_compagny_serie DROP FOREIGN KEY FK_CCD043CE759F4088');
        $this->addSql('ALTER TABLE original_country_serie DROP FOREIGN KEY FK_C2BB5F81949849E4');
